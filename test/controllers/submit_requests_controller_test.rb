...
class SubmitRequestsControllerTest < ActionController::TestCase
  ...
  test "should create submit_request" do
    assert_difference('SubmitRequest.count') do
      post :create, submit_request: { memo: @submit_request.memo, request_user_id: @submit_request.request_user_id, status: @submit_request.status, user_id: @submit_request.user_id, work_id: @submit_request.work_id }
    end
  ...
  test "should update submit_request" do
    patch :update, id: @submit_request, submit_request: { memo: @submit_request.memo, request_user_id: @submit_request.request_user_id, status: @submit_request.status, user_id: @submit_request.user_id, work_id: @submit_request.work_id }
    assert_redirected_to submit_request_path(assigns(:submit_request))
  end
